...
const ApplicantsAbout = () => {
  return (
    <div className="font-medium flex flex-col justify-center items-center gap-4 bg-backgroundSlate py-8 px-4 mt-2">
      ...
      <div className=" flex flex-col gap-10">
        <div className=" flex flex-col justify-center items-center gap-1 ">
          ...
          <p className=" text-sm sm:text-base text-opacity-50 text-white">
            Get to call themselves BRAND NAME chauffeurs
          </p>
        </div>
        <div className=" flex flex-col items-center justify-center gap-4">
          <h1 className=" text-2xl sm:text-3xl">Our Evaluation</h1>
          <div className=" text-left text-sm sm:text-base flex flex-col gap-1">
